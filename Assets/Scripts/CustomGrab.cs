    ...
    void Update()
    {
        ...
        if (grabbing)
        {
            ...
            if (grabbedObject)
            {
                ...
                Vector3 prevGrabbedLocal = grabbedObject.position - transform.position;
                Vector3 rotatedGrabbedLocal = deltaRot * prevGrabbedLocal;
                grabbedObject.position += rotatedGrabbedLocal - prevGrabbedLocal;
